...
function inline(msg)
	thumb = "https://telegram.me/wolf_bottt/inline_icons/"
	local f = io.open("./about.txt")
	if f then
		s = f:read('*all')
		f:close()
	...
	bioinfo = infotxtin.."*Name:* "..sudo_name.."\n*Username:* [@"..sudo_user.."](https://telegram.me/"..sudo_user..")\n*Mobile:* +"..sudo_num.."\n*Telegram ID:* "..sudo_id.."\n*Channel:* [@"..sudo_ch.."](https://telegram.me/"..sudo_ch..")\n\n_Powered by_ [wolfTeam](https://telegram.me/wolf_bottt)"
	tabless = '[{"text":"اکانت اصلی من","url":"https://telegram.me/'..sudo_user..'"}],[{"text":"کانال شخصی من","url":"https://telegram.me/'..sudo_ch..'"}],[{"text":"کانال سازنده","url":"https://telegram.me/wolf_bottt"},{"text":"سازنده ربات","url":"https://telegram.me/pvmorteza_bot"}]'
